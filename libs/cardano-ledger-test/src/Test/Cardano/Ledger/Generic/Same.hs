...
sameConwayTxBody
  proof
  (ConwayTxBody i1 cl1 ri1 o1 cr1 tc1 c1 (Withdrawals w1) f1 v1 r1 m1 s1 d1 n1 vp1 pp1 td1)
  (ConwayTxBody i2 cl2 ri2 o2 cr2 tc2 c2 (Withdrawals w2) f2 v2 r2 m2 s2 d2 n2 vp2 pp2 td2) =
    [ ("SpendInputs", eqVia (ppSet pcTxIn) i1 i2)
    , ("ColInputs", eqVia (ppSet pcTxIn) cl1 cl2)
    , ("RefInputs", eqVia (ppSet pcTxIn) ri1 ri2)
    , ("Outputs", eqVia (ppList (pcTxOut proof . sizedValue) . toList) o1 o2)
